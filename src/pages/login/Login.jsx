    ...
    <div className="w-11/12 lg:container mx-auto min-h-screen bg-cover flex justify-center items-center">
      <div className="justify-center items-center">
        ...
        >
          ...
          <button className="btn bg-clr-secondary hover:bg-clr-main rounded-full border-0 text-xl text-white">
            Log In
          </button>
          <p className="text-center text-xl font-bold">Or</p>
          <Link className="btn border border-clr-secondary rounded-full text-xl ">
            <FcGoogle />
            Log In with Google
          </Link>
